...
<body>
  ...
  <section id="job">
    ...
    <p>LMO Advertising, a fast-growing, Arlington, VA-based advertising agency, has an exciting opportunity for a <strong>detailed oriented Account Executive</strong> in our <strong>Marketing</strong> Department.</p>
    
    <p>The Account Executive will be responsible for managing many multi-faceted projects and campaigns. The position entails: account management/client service and marketing of the agency. </p>

    <p>Reports to: Director of Marketing</p>

    <h2>Responsibilities:</h2>
    <ul>
      <li>Provide day-to-day client management services for several clients</li>
      <li>Manage all aspects of campaigns from ideation to execution</li>
      <li>Write and coordinate business development pitches and proposals</li>
      <li>Monitor federal, state, and local government RFPs</li>
      <li>Maintain new business materials such as agency case studies, standard language, and other documents</li>
      <li>Assist with marketing of the agency including planning events, developing marketing materials, and maintaining the LMO website</li>
    </ul>

    <h2>Qualifications:</h2>
    <ul>
      <li>Must have 3-5 years of relevant work experience</li>
      <li>Bachelor’s degree in business, marketing, advertising, or related field of study</li>
      <li>Analytical, strategic thinker, knowledge of advertising process</li>
      <li>Proficient in Microsoft Suite</li>
      <li>Excellent organizational skills</li>
      <li>Detail oriented</li>
      <li>Strong sense of initiative and ability to work under pressure on multiple projects</li>
      <li>Previous management of Account Coordinator or Interns a plus</li>
    </ul>

    <p>Interested candidates please e-mail your resume to <a href="mailto:AEMktg@lmo.com">AEMktg@lmo.com</a>.</strong> No phone calls please. LMO is a member of the AAAA and an equal opportunity employer.</p>
  </div>
  </section>
