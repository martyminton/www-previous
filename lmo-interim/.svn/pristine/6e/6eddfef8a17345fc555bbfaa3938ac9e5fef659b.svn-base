...
<body>
	...
	<section id="job">
		<div class="contain">
		<h1>Account Executive: Database Marketing</h1>
		<h2>Job Description</h2>
		<p>LMO Advertising, a fast-growing Arlington, VA-based advertising agency, is seeking an Account Executive in our Account Service department. Level of experience is 2-4 years working on large database marketing programs; experience with reporting analytics is imperative. </p>

		<p>Reports to: Account Supervisor</p>

		<p>Job Purpose: Manage the implementation and integration of the Client's marketing plans/communications strategy through the lead processing database.</p>

		<p>The ideal candidate will have 2-4 years experience within a database or direct marketing department.</p>

		<p><strong>Responsibilities Include: </strong></p>
		<ul>
			<li>Interprets client's business needs and translates them into application and operational requirements</li>
			<li>Collaborates with subject matter experts to establish technical vision</li>
			<li>Works with client and agency to identify reporting needs, opportunities and plans for implementation</li>
			<li>Monitors lead processing center database, call centers, online admin center and reporting</li>
			<li>Ensures accessibility to data for decision making and program evaluations</li>
			<li>Monitors reporting or analysis requests to ensure effective and timely response</li>
			<li>Reports to the client on a regular basis</li>
		</ul>

		<h2>Desired Skills and Experience</h2>
		<p><strong>Required Qualifications:</strong></p>
		<ul>
			<li>Bachelor's degree in business, marketing, advertising, or related field of study</li>
			<li>Analytical, strategic thinking/processing, knowledge of total advertising process</li>
			<li>Proficiency in Microsoft Excel, Word, Access and PowerPoint</li>
			<li>The ability to multi-task on numerous accounts or campaigns</li>
			<li>Experience analyzing complex data, market research and formulating actionable plans</li>
			<li>Effective time management and organizational skills, as well as strong attention to detail</li>
			<li>Review appropriateness of materials created internally</li>
			<li>Basic to intermediate SQL language and/or Salesforce API coding ability</li>
 		</ul>

		<p>Interested candidates please e-mail your resume to <strong><a href="mailto:DatabaseAE@lmo.com">DatabaseAE@lmo.com.</a></strong> No phone calls please. LMO is a member of the AAAA and an equal opportunity employer.</p>
	</div>
	</section>
