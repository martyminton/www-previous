...
<body>
	...
	<section id="job">
		...
		<p>LMO Advertising, a fast-growing Arlington, VA-based advertising agency, has an exciting opportunity for an organized, multi-tasking, Account Coordinator in our Account Management department. Managing many projects at once and keeping projects on schedule is the main priority of the Account Coordinator. In order for programs to continue growing in scope and efficiency, we require additional support in our account management department. </p>

		<p>Reports to: Account Executive and Account Supervisor</p>

		<p>Job Purpose: Manage the implementation and integration of Client's projects  </p>

		<p>The ideal candidate will have 1+ years of working experience in a marketing/advertising environment</p>

		<h2>Responsibilities Include: </h2>
		<ul>
			<li>Maintains direct communication with the client</li>
			<li>Assist with development and implementation of campaigns, media plans, projects</li>
			<li>Manages project timetables, budgets and approvals</li>
			<li>Coordinates, authorizes and provides Clients with estimates and budget updates on all projects.</li>
		</ul>

		<h2>Required Qualifications: </h2>
		<ul>
			<li>Bachelor's degree in business, marketing, advertising, or related field of study</li>
			<li>Time management, analytical, strategic thinking/processing, knowledge of total advertising process</li>
			...
			<li>Appropriateness of materials created internally</li>
		</ul>



		<p>Interested candidates please e-mail your resume to <a href="mailto:AC@lmo.com">AC@lmo.com</a>.</strong> No phone calls please. LMO is a member of the AAAA and an equal opportunity employer.</p>
	</div>
	</section>
