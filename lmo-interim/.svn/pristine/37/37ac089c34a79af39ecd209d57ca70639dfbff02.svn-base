...
function firstImpression() {
	...
	setTimeout(function(){
		$('#home h2, #home .cta').addClass('animated bounceInDown').delay(500).css({opacity: 1});
	},1000);

	setTimeout(function(){
		$('nav li.purpose').addClass('animated bounceInDown').delay(500).css({opacity: 1});
	},1100);

	setTimeout(function(){
		$('nav li.work').addClass('animated bounceInDown').delay(500).css({opacity: 1});
	},1200);
