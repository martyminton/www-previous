...
<body>
  ...
  <section id="job">
    <div class="contain">
    <h1>SSIS Developer</h1>
    <h2>Job Description</h2>
    <p>Vim Interactive, Inc., a LMO Advertising company, is a software development shop and digital agency with an exciting opportunity for an experienced SSIS Developer in our downtown Baltimore, MD office.</p>

    <p>Vim is currently seeking a strong SSIS developer who takes pride in developing ETL and synchronization processes for a complex constantly evolving system.  This developer will developing complex MS SQL Server queries and SSIS packages &amp; custom tasks for performing data conversions (ETL) to import and export data for external vendors and synchronized systems.  The position also includes data extraction, reporting, SQL Server stored procedure development and the maintenance of tables, views and other schema elements. The position also includes development of reports in Salesforce and Marketo.</p>

    <p>The ideal candidate would be a SQL Server &amp; SSIS rockstar with deep experience working with large complex data-driven applications. Additionally, the candidate will work as well individually as they do in a small, collaborative team. They should enjoy variety in their work while meeting deadlines without breaking a sweat.</p>

    <h2>At the minimum, you’ll possess deep experiences with:</h2>
    <ul>
      <li>SQL Server SSIS Development</li>
      <li>ETL Development</li>
      <li>T-SQL Development</li>
      <li>C#</li>
      <li>Development of Custom Tasks for SSIS</li>
    </ul>

    <h2>You'll impress us even more if you have experience with the following:</h2>
    <ul>
      <li>Salesforce</li>
      <li>Marketo</li>
      <li>Marketing support systems</li>
      <li>Recruitment support systems</li>
    </ul>

    <p>Reports to: .Net Development Lead</p>

    <h2>Qualifications:</h2>
    <ul>
      <li>Bachelor’s degree in Information Technology, Computer Science or related field from an accredited four-year university</li>
      <li>3+ years of SQL Server and SSIS development</li>
      <li>1+ years of SQL Server stored procedure &amp; C# development experience</li>
    </ul>

    <p>Interested candidates please e-mail your resume to <a href="mailto:SSISDev@lmo.com">SSISDev@lmo.com</a>.</strong> No phone calls please. LMO is a member of the AAAA and an equal opportunity employer.</p>
  </div>
  </section>
