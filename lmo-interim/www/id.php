...
<body>
	...
	<header class="default secondary">
		<div class="contain">
			<nav>
				<ul>
	...
	<section id="job">
		...
		<p>LMO Advertising, Washington, D.C. metro area's largest independently owned advertising agency, has an exciting opportunity for an Interactive Designer in our Creative Department.</p>

		<p>We are looking for a passionate, digitally focused interactive designer to support our rapidly evolving creative and interactive departments. The right candidate will step into a fast-paced, deadline driven, team environment and be able to manage multiple projects. This position will focus on the execution of Flash and rich media web banners, landing pages, microsites, home page takeovers, HTML e-blasts and other interactive projects. Interactive design and front-end development are mandatory skills.</p>

		<h2>Required Skills</h2>
		<ul>
			<li>At least 2 years experience in an advertising agency, client-side marketing/advertising department or a related field</li>
			<li>Strong Adobe Photoshop and Adobe Flash skills</li>
			<li>Expert knowledge of Flash banner animation, XHTML, CSS and JavaScript</li>
			<li>Hand-Coding and Rich Media experience</li>
			<li>Attention to detail, organizational and interpersonal skills are critical</li>
			<li>Knowledge of Adobe Creative Suite at an intermediate to advance level</li>
			<li>Strong design and typography fundamentals</li>
			<li>Works well under pressure and tight deadlines</li>
		</ul>

		<h2>Responsibilities</h2>
		<ul>
				<li>Design and layout story board for web banners</li>
				<li>Build animated and static Flash banner in standard sizes</li>
				<li>Design and code e-mail blasts in HTML and In-Line CSS to provided specifications; and ensure they work industry standard email clients</li>
				<li>Code microsites and landing pages in HTML, CSS and JavaScript to provided specifications: and ensure they work properly on all web browsers</li>
				<li>Participate in creative brainstorm meetings as well as new business pitches</li>
				<li>Ability to understand and maintain our clients' brands, voices and messaging</li>
		</ul>

		<h2>Always a Plus</h2>
		<ul>
			<li>Experience with HTML5 and CSS3, mobile apps and websites for the mobile environment</li>
			<li>Understanding of Responsive design</li>
			<li>An understanding of content management platforms and database-driven sites and emerging technologies</li>
			<li>Flash ActionScript 2-3 programming experience</li>
		</ul>
		<p>Interested candidates please e-mail your resume to <a href="mailto:GraphicDesigner@lmo.com">GraphicDesigner@lmo.com</a>.</strong> No phone calls please. LMO is a member of the AAAA and an equal opportunity employer.</p>
	</div>
	</section>
	...
	<script src="/build/js/main_job.js"></script>
