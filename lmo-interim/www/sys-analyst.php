...
<body>
  ...
  <section id="job">
    ...
    <p>Vim Interactive, Inc., a LMO Advertising company, is a software development shop and digital agency with an exciting opportunity for an experienced Systems Analyst in our downtown Baltimore, MD office. </p>

    <p>Vim is currently seeking a strong Systems Analyst who takes pride in mastering complex data sets and business rules.   This Systems Analyst will use their business, data analysis, programming, and quality assurance skills to be the first line of defense for data integrity and business continuity.  This Systems Analyst will work directly with our clients to refine business rules and answer questions.  This position also includes reporting and programming using SQL Server, Salesforce, C#, SSIS and Marketo.</p>

    <p>The ideal candidate is a developer with deep experience in business and data analysis. Additionally, the candidate will work as well individually as they do in a small, collaborative team. They should enjoy variety in their work while meeting deadlines without breaking a sweat.</p>
    ...
    <ul>
      ...
      <li>5+ years of experience in software development and SQL</li>
      <li>3+ years of Systems Analysis or Business Analyst Experience</li>
      <li>2+ years of C# and SQL Server experience</li>
    </ul>

    <p>Interested candidates please e-mail your resume to <a href="mailto:SystemsAnalyst@lmo.com">SystemsAnalyst@lmo.com</a>.</strong> No phone calls please. LMO is a member of the AAAA and an equal opportunity employer.</p>
  </div>
  </section>
